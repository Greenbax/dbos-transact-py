...
class DBOSConfig(TypedDict, total=False):
    ...
    Attributes:
        ...
        system_database_engine (Engine): A custom system database engine. If provided, DBOS will not create an engine but use this instead.
    ...
    system_database_engine: Optional[Engine]
